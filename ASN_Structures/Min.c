...
int
Min_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
Min_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
Min_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	Min_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
Min_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
Min_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Min_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
Min_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
Min_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_Min_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (146 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (4 << 2))
};
asn_TYPE_descriptor_t asn_DEF_Min = {
	"Min",
	"Min",
	Min_free,
	Min_print,
	...
	asn_DEF_Min_tags_1,
	sizeof(asn_DEF_Min_tags_1)
		/sizeof(asn_DEF_Min_tags_1[0]) - 1, /* 1 */
	asn_DEF_Min_tags_1,	/* Same as above */
	sizeof(asn_DEF_Min_tags_1)
		/sizeof(asn_DEF_Min_tags_1[0]), /* 2 */
