...
static asn_TYPE_member_t asn_MBR_TrackingCustomerHomeId_1[] = {
...
static ber_tlv_tag_t asn_DEF_TrackingCustomerHomeId_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (366 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TrackingCustomerHomeId_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (288 << 2)), 1, 0, 0 }, /* homeIdentifier */
    { (ASN_TAG_CLASS_APPLICATION | (311 << 2)), 0, 0, 0 } /* homeIdType */
};
static asn_SEQUENCE_specifics_t asn_SPC_TrackingCustomerHomeId_specs_1 = {
