...
static asn_TYPE_member_t asn_MBR_HomeLocationInformation_1[] = {
...
static ber_tlv_tag_t asn_DEF_HomeLocationInformation_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (123 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_HomeLocationInformation_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (122 << 2)), 0, 0, 0 }, /* homeBid */
    { (ASN_TAG_CLASS_APPLICATION | (413 << 2)), 1, 0, 0 } /* homeLocationDescription */
};
static asn_SEQUENCE_specifics_t asn_SPC_HomeLocationInformation_specs_1 = {
