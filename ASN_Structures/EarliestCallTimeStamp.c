...
int
EarliestCallTimeStamp_constraint(asn_TYPE_descriptor_t *td, const void *sptr,
 ...
 */
static void
EarliestCallTimeStamp_1_inherit_TYPE_descriptor(asn_TYPE_descriptor_t *td) {
...
void
EarliestCallTimeStamp_free(asn_TYPE_descriptor_t *td,
		void *struct_ptr, int contents_only) {
	EarliestCallTimeStamp_1_inherit_TYPE_descriptor(td);
	td->free_struct(td, struct_ptr, contents_only);
}

int
EarliestCallTimeStamp_print(asn_TYPE_descriptor_t *td, const void *struct_ptr,
...
asn_dec_rval_t
EarliestCallTimeStamp_decode_ber(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EarliestCallTimeStamp_encode_der(asn_TYPE_descriptor_t *td,
...
asn_dec_rval_t
EarliestCallTimeStamp_decode_xer(asn_codec_ctx_t *opt_codec_ctx, asn_TYPE_descriptor_t *td,
...
asn_enc_rval_t
EarliestCallTimeStamp_encode_xer(asn_TYPE_descriptor_t *td, void *structure,
...
static ber_tlv_tag_t asn_DEF_EarliestCallTimeStamp_tags_1[] = {
...
asn_TYPE_descriptor_t asn_DEF_EarliestCallTimeStamp = {
	...
	"EarliestCallTimeStamp",
	EarliestCallTimeStamp_free,
	EarliestCallTimeStamp_print,
	EarliestCallTimeStamp_constraint,
	EarliestCallTimeStamp_decode_ber,
	EarliestCallTimeStamp_encode_der,
	EarliestCallTimeStamp_decode_xer,
	EarliestCallTimeStamp_encode_xer,
