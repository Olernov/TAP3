...
static asn_TYPE_member_t asn_MBR_InternetServiceProvider_1[] = {
...
static ber_tlv_tag_t asn_DEF_InternetServiceProvider_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (329 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_InternetServiceProvider_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (293 << 2)), 0, 0, 0 }, /* ispIdType */
    { (ASN_TAG_CLASS_APPLICATION | (294 << 2)), 1, 0, 0 } /* ispIdentifier */
};
static asn_SEQUENCE_specifics_t asn_SPC_InternetServiceProvider_specs_1 = {
