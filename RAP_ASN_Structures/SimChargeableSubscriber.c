...
static asn_TYPE_member_t asn_MBR_SimChargeableSubscriber_1[] = {
...
static ber_tlv_tag_t asn_DEF_SimChargeableSubscriber_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (199 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_SimChargeableSubscriber_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (129 << 2)), 0, 0, 0 }, /* imsi */
    { (ASN_TAG_CLASS_APPLICATION | (152 << 2)), 1, 0, 0 } /* msisdn */
};
static asn_SEQUENCE_specifics_t asn_SPC_SimChargeableSubscriber_specs_1 = {
