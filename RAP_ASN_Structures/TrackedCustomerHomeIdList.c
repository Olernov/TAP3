...
static asn_TYPE_member_t asn_MBR_TrackedCustomerHomeIdList_1[] = {
	{ ATF_POINTER, 0, 0,
...
static ber_tlv_tag_t asn_DEF_TrackedCustomerHomeIdList_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (376 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SET_OF_specifics_t asn_SPC_TrackedCustomerHomeIdList_specs_1 = {
