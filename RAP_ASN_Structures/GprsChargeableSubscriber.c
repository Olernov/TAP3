...
static asn_TYPE_member_t asn_MBR_GprsChargeableSubscriber_1[] = {
...
static ber_tlv_tag_t asn_DEF_GprsChargeableSubscriber_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (115 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_GprsChargeableSubscriber_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_GprsChargeableSubscriber_specs_1 = {
