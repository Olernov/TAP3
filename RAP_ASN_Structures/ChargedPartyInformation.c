...
static asn_TYPE_member_t asn_MBR_ChargedPartyInformation_1[] = {
...
static ber_tlv_tag_t asn_DEF_ChargedPartyInformation_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (324 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_ChargedPartyInformation_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_ChargedPartyInformation_specs_1 = {
