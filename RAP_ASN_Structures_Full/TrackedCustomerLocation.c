...
static asn_TYPE_member_t asn_MBR_TrackedCustomerLocation_1[] = {
...
static ber_tlv_tag_t asn_DEF_TrackedCustomerLocation_tags_1[] = {
	(ASN_TAG_CLASS_APPLICATION | (380 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_TYPE_tag2member_t asn_MAP_TrackedCustomerLocation_tag2el_1[] = {
    { (ASN_TAG_CLASS_APPLICATION | (289 << 2)), 1, 0, 0 }, /* locationIdentifier */
    { (ASN_TAG_CLASS_APPLICATION | (315 << 2)), 0, 0, 0 } /* locationIdType */
};
static asn_SEQUENCE_specifics_t asn_SPC_TrackedCustomerLocation_specs_1 = {
